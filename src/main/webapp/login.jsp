...
.container-fluid:before {
  ...
  background-image: linear-gradient(-45deg, #ec2829 0%, #D00000 100%);
      ...
      <div class="forms-container">
        <div class="signin-signup">
          <form action="LoginController" method="post" class="sign-in-form">
            ...
            <a href="forgotpassword" style="color: #ec2829; text-decoration: none">Forgot Password?</a>
      ...
      <div class="panels-container">
        <div class="panel left-panel">
          <div class="content">
            <h3>New here ?</h3>
            <p>
            Please create a account to be a part of digiXam!
            </p>
            <button class="btn transparent" id="sign-up-btn">
              Sign up
            </button>
          </div>
          <img src="Assets/img/signup/log.svg" class="image" alt="" />
        </div>
        <div class="panel right-panel">
          ...
          <img src="Assets/img/signup/register.png" class="image" alt="" />
        </div>
      </div>
    </div>
