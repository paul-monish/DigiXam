      ...
      <div class="col-12">
		...
		<div class="card text-center">
		  <div class="card-header" style="text-align:left;">
		    <h4><%=new DatabaseDAO().getSubjectName(Integer.parseInt((String)session.getAttribute("id"))).toUpperCase()%>
		  </h4>
		  </div>
		  <div class="card-body">
		<%for(String f :file) {%>
		 ...
		 <%} %> 
		  ...
		  <div class="card-footer text-muted">
		    <a href="<%=request.getContextPath()%>/screen2?qsn_id=<%=request.getParameter("qsn_id") %>" class="btn btn-success">Next</a>
		  </div>
		</div>
